...
export const validateCreateOrder = [
  ...
  check("items")
    ...
    .withMessage(
      "Каждый элемент 'items' должен содержать поля 'product' (строка), 'seller' (строка), 'quantity' (положительное число), и 'priceAtPurchase' (неотрицательное число)."
    ),
  check("shippingDetails")
    ...
    .withMessage(
      "Поле 'shippingDetails' должно содержать 'address' (строка), 'city' (строка), 'country' (строка), 'postalCode' (строка), и 'shippingCost' (неотрицательное число)."
    ),
  check("paymentDetails")
    ...
    .withMessage(
      "Поле 'paymentDetails' должно содержать 'method' (один из 'card', 'paypal', 'cash_on_delivery') и 'amountPaid' (неотрицательное число)."
    ),
